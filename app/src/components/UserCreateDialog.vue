<template>
  <q-dialog persistent ref="userCreationDialog">
    <q-card style="max-width: 800px">
      ...
      <q-card-section>
        <q-form ref="userForm" @submit="storeUser" class="q-gutter-md">
          <div
            style="
              display: flex;
          ...
          >
            ...
            <div style="min-width: 300px" class="q-pa-md">
              ...
              <q-select
                ...
                filled
                v-model="refereeType"
                :options="refereeTypeOptions"
                label="Lista sudije"
                hint="Izaberite sa koje je liste sudija"
              />
              <q-input
                ...
                :rules="[
                  (val) =>
                    (val && val.length > 5) ||
                    'Ovo polje mora imati minimum 5 karaktera!',
                ]"
...
const buttonAction =
  props.mode === 'create' ? 'Kreiraj korisnika' : 'Ažuriraj korisnika';
